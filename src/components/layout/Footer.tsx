...
export default function Footer() {
  ...
  return (
    <footer className="bg-dark-steel">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-11 h-11 rounded-lg bg-dark-mid border border-dark-border flex items-center justify-center text-[#94A3B8] hover:text-cobersteel-gold hover:border-cobersteel-gold transition-colors"
              >
          ...
          <div>
            ...
            <ul className="space-y-0">
              <li>
                <Link href="/institucional/quem-somos" className="block py-2.5 text-sm text-[#94A3B8] hover:text-white transition-colors">
                  Quem Somos
                </Link>
              </li>
              <li>
                <Link href="/institucional/portfolio" className="block py-2.5 text-sm text-[#94A3B8] hover:text-white transition-colors">
                  Portfólio
                </Link>
              </li>
              <li>
                <Link href="/institucional/normas-abnt" className="block py-2.5 text-sm text-[#94A3B8] hover:text-white transition-colors">
                  Normas ABNT
                </Link>
              </li>
              <li>
                <Link href="/institucional/trabalhe-conosco" className="block py-2.5 text-sm text-[#94A3B8] hover:text-white transition-colors">
                  Trabalhe Conosco
                </Link>
              </li>
              <li>
                <Link href="/institucional/fornecedores" className="block py-2.5 text-sm text-[#94A3B8] hover:text-white transition-colors">
                  Seja um Fornecedor
                </Link>
              </li>
              <li>
                <Link href="/blog" className="block py-2.5 text-sm text-[#94A3B8] hover:text-white transition-colors">
                  Blog
                </Link>
              </li>
              <li>
                <Link href="/institucional/privacidade" className="block py-2.5 text-sm text-[#94A3B8] hover:text-white transition-colors">
                  Privacidade
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-0">
              ...
              <li>
                <Link href="/servicos" className="block py-2.5 text-sm text-[#94A3B8] hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex gap-2.5 text-sm text-[#94A3B8]">
                ...
                <div>
                  <a href={`tel:${CONTACT_INFO.phone1.replace(/\D/g, "")}`} className="hover:text-white transition-colors block py-2.5">
                    {CONTACT_INFO.phone1}
                  </a>
                  <a href={CONTACT_INFO.whatsappLink} target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors block py-2.5">
              ...
              <li className="flex gap-2.5 text-sm text-[#94A3B8]">
                ...
                <a href={`mailto:${CONTACT_INFO.email}`} className="hover:text-white transition-colors inline-block py-2.5">
                  {CONTACT_INFO.email}
                </a>
              </li>
            </ul>
