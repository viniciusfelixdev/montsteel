...
import LegacyBlogRedirect from "@/components/blog/LegacyBlogRedirect";
...
/** Conteúdo compartilhado por /blog, /blog/pagina/[page], /blog/categoria/[categoria]
 *  e /blog/categoria/[categoria]/pagina/[page] — cada rota só resolve seus próprios
 *  params e delega a renderização pra cá. */
export default async function BlogListing({
  ...
  let activeCategory: (typeof categories)[number] | undefined;
  if (categorySlug) {
  ...
  const [{ posts, totalPages }, { posts: recentPosts }] = await Promise.all([
    ...
    <>
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        <Image
          ...
          quality={50}
          placeholder="blur"
          blurDataURL={IMAGE_BLUR["/images/blog-banner.webp"]}
          sizes="100vw"
      ...
      <Suspense fallback={null}>
        <LegacyBlogRedirect categories={categories} />
      </Suspense>
            ...
            <div className="lg:col-span-2">
              ...
              {totalPages > 1 && (
                <div className="flex items-center justify-center gap-2 mt-10">
                  <Link
                    href={blogPageHref(page - 1, categorySlug)}
                  ...
                  <ul className="space-y-0">
                    {categories.map((cat) => {
                      ...
                      return (
                        <li key={cat.id}>
                          <Link
                            href={isActive ? "/blog" : blogPageHref(1, cat.slug)}
