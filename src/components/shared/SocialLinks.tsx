...
const NETWORKS: { key: keyof typeof ICONS; label: string; href: string }[] = [
  { key: "instagram", label: "Instagram", href: CONTACT_INFO.instagram },
  { key: "youtube", label: "YouTube", href: CONTACT_INFO.youtube },
  { key: "linkedin", label: "LinkedIn", href: CONTACT_INFO.linkedin },
  { key: "facebook", label: "Facebook", href: CONTACT_INFO.facebook },
];
