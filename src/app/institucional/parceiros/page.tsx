...
export const metadata: Metadata = {
  title: "Parceiros | MontSteel — Galpões e Coberturas Industriais",
  description:
    "Conheça os parceiros estratégicos da MontSteel e os cases de sucesso desenvolvidos em conjunto para o setor de infraestrutura industrial.",
    ...
    <>
      ...
      <section className="relative institucional-banner-padding-bottom overflow-hidden bg-gradient-to-br from-dark-steel to-dark-mid">
        <div className="institucional-content-offset institucional-content-min-height relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            NOSSOS <span className="text-montsteel-blue">PARCEIROS</span>
          </h1>
      ...
      <section className="bg-light-bg dark:bg-dark-steel py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="w-14 h-14 rounded-xl bg-montsteel-blue/15 flex items-center justify-center mx-auto mb-6">
            <Handshake className="w-7 h-7 text-montsteel-blue" aria-hidden="true" />
          </div>
          <h2
