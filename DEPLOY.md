# Checklist de Publicação — CoberSteel
...
- [ ] Domínio `cobersteel.com.br` com acesso ao painel de DNS
...
| `EMAIL_FROM` | `CoberSteel <site@cobersteel.com.br>` | Use `onboarding@resend.dev` até verificar o domínio |
| `EMAIL_TO` | `contato@cobersteel.com.br` | Onde os leads chegam |
| `NEXT_PUBLIC_SITE_URL` | `https://www.cobersteel.com.br` | URL pública (sitemap/OG) |
| `NEXT_PUBLIC_BLOG_URL` | `https://blog.cobersteel.com.br` | Link "Blog" do menu |
...
- [ ] Apontar o domínio `cobersteel.com.br` (e `www`) para a Vercel (registros A/CNAME)
- [ ] SSL é automático na Vercel

## 4. E-mail (Resend) — produção
- [ ] Em Resend → Domains, adicionar `cobersteel.com.br`
- [ ] Inserir os registros DNS (SPF/DKIM) que o Resend fornecer
- [ ] Após verificado, trocar `EMAIL_FROM` para `@cobersteel.com.br`
- [ ] Testar envio pelos formulários de Orçamento e Fornecedores

## 5. SEO pós-deploy
- [ ] Google Search Console: adicionar a propriedade do domínio
- [ ] Enviar o sitemap: `https://www.cobersteel.com.br/sitemap.xml`
- [ ] Conferir `robots.txt`: `https://www.cobersteel.com.br/robots.txt`
- [ ] Validar dados estruturados no [Rich Results Test](https://search.google.com/test/rich-results)

## 6. Blog (WordPress)
- [ ] Instalar o WordPress no subdomínio `blog.cobersteel.com.br`
